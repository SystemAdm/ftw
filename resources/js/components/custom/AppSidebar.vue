...
import { index as adminRelationsRoute } from '@/routes/admin/relations';
...
import { index as adminOpenRoute } from '@/routes/admin/open';
import { index as modOpenRoute } from '@/routes/mod/open';
