...
import {
    ...
    edit as editRoute,
    forceDestroy as forceDestroyRoute,
    index as indexRoute,
                    ...
                    <template v-if="!postcode.deleted_at">
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    <AlertDialogTitle>{{
                                        trans('pages.settings.postcodes.delete.title', { code: postcode.postal_code })
                                    }}</AlertDialogTitle>
                                    <AlertDialogDescription>
                    ...
                    <template v-else>
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    <AlertDialogTitle>{{
                                        trans('pages.settings.postcodes.force_delete.title', { code: postcode.postal_code })
                                    }}</AlertDialogTitle>
                                    <AlertDialogDescription>
                                ...
                                <AlertDialogFooter>
                                    <AlertDialogCancel>{{ trans('pages.settings.postcodes.actions.cancel') }}</AlertDialogCancel>
                                    <AlertDialogAction @click="forceDel">{{
                                        trans('pages.settings.postcodes.actions.delete_permanently')
                                    }}</AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        </AlertDialog>
            ...
            <CardContent>
                <div class="rounded-md border bg-card p-4">
                    <dl class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                        <div>
                            <dt class="text-xs tracking-wide text-muted-foreground uppercase">{{ trans('pages.settings.postcodes.fields.city') }}</dt>
                            <dd class="mt-1 text-sm font-medium">{{ postcode.city }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs tracking-wide text-muted-foreground uppercase">
                                {{ trans('pages.settings.postcodes.fields.state') }}
                            </dt>
                            <dd class="mt-1 text-sm font-medium">{{ postcode.state || '—' }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs tracking-wide text-muted-foreground uppercase">
                                {{ trans('pages.settings.postcodes.fields.country') }}
                            </dt>
                            <dd class="mt-1 text-sm font-medium">{{ postcode.country }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs tracking-wide text-muted-foreground uppercase">
                                {{ trans('pages.settings.postcodes.fields.municipality') }}
                            </dt>
