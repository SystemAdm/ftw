...
import { create, show as showRoute, edit as editRoute, destroy as destroyRoute, restore as restoreRoute, forceDestroy as forceDestroyRoute } from '@/routes/admin/postcodes';
