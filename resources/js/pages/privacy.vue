        ...
        <div class="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
            ...
            <nav class="mb-8 rounded-lg border p-4">
                ...
                <ul class="mt-3 grid gap-2 text-sm text-muted-foreground">
                    <li>
                        <a class="hover:underline" href="#who">{{ t.toc?.who ?? 'Who we are' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#data">{{ t.toc?.data ?? 'Data we collect' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#use">{{ t.toc?.use ?? 'How we use your data' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#legal">{{ t.toc?.legal ?? 'Legal bases' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#share">{{ t.toc?.share ?? 'Sharing' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#payments">{{ t.toc?.payments ?? 'Payments (Stripe)' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#cookies">{{ t.toc?.cookies ?? 'Cookies' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#retention">{{ t.toc?.retention ?? 'Retention' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#rights">{{ t.toc?.rights ?? 'Your rights' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#children">{{ t.toc?.children ?? 'Children' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#transfers">{{ t.toc?.transfers ?? 'International transfers' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#security">{{ t.toc?.security ?? 'Security' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#contact">{{ t.toc?.contact ?? 'Contact' }}</a>
                    </li>
                    <li>
                        <a class="hover:underline" href="#changes">{{ t.toc?.changes ?? 'Changes to this notice' }}</a>
                    </li>
                </ul>
            </nav>
            ...
            <section id="contact" class="mb-8 space-y-2">
                ...
                <p class="text-sm text-muted-foreground">
                    {{ t.contact?.body }}
                    <Link href="/contact" class="transition hover:text-foreground">
                        <span class="text-foreground" v-html="ui.contact?.form ?? 'Contact form'"></span> </Link
                    >{{ ui.contact?.or ?? '' }} <span v-html="ui.contact?.direct ?? ''"></span>
                </p>
            </section>
